module ApiKeyAuthenticatable
  ...
  #
  # use this to raise an error and automatically respond with a 401 HTTP
  # status code when API key authentication fails
  #
  ...
  def authenticate_with_api_key
    @current_bearer =
      authenticate_with_http_token(&method(:authenticator))
  end
