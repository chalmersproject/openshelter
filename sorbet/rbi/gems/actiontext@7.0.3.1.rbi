...
class ActionText::Attachment
  ...
  include ::ActionText::Attachments::TrixConversion::Extension
...
class ActionText::RichText < ::ActionText::Record
  ...
  class << self
    ...
    # source://activestorage/7.0.3.1/lib/active_storage/reflection.rb#53
...
module ActionText::RichText::EmbedsAttachmentsAssociationExtension
  # source://activestorage/7.0.3.1/lib/active_storage/attached/model.rb#165
  def purge; end

  # source://activestorage/7.0.3.1/lib/active_storage/attached/model.rb#171
  def purge_later; end

  private

  # source://activestorage/7.0.3.1/lib/active_storage/attached/model.rb#178
  def deprecate(action); end
end

module ActionText::RichText::GeneratedAssociationMethods
  # source://activestorage/7.0.3.1/lib/active_storage/attached/model.rb#134
  def embeds; end

  # source://activestorage/7.0.3.1/lib/active_storage/attached/model.rb#139
