...
module Geocoder::Lookup
  ...
  #
  # source://geocoder//lib/geocoder/lookup.rb#106
  def get(name); end
  ...
  #
  # source://geocoder//lib/geocoder/lookup.rb#99
  ...
  #
  # source://geocoder//lib/geocoder/lookup.rb#139
  def instantiate_lookup(name); end

  # Spawn a Lookup of the given name.
  #
  # source://geocoder//lib/geocoder/lookup.rb#118
  def spawn(name); end
end
...
# source://geocoder//lib/geocoder/lookups/google.rb#5
class Geocoder::Lookup::Google < ::Geocoder::Lookup::Base
  # source://geocoder//lib/geocoder/lookups/google.rb#11
  def map_link_url(coordinates); end

  # source://geocoder//lib/geocoder/lookups/google.rb#7
  def name; end

  # source://geocoder//lib/geocoder/lookups/google.rb#15
  def supported_protocols; end

  private

  # source://geocoder//lib/geocoder/lookups/google.rb#26
  def base_query_url(query); end

  # source://geocoder//lib/geocoder/lookups/google.rb#30
  def configure_ssl!(client); end

  # source://geocoder//lib/geocoder/lookups/google.rb#69
  def query_url_google_params(query); end

  # source://geocoder//lib/geocoder/lookups/google.rb#94
  def query_url_params(query); end

  # source://geocoder//lib/geocoder/lookups/google.rb#47
  def result_root_attr; end

  # source://geocoder//lib/geocoder/lookups/google.rb#51
  def results(query); end

  # @return [Boolean]
  #
  # source://geocoder//lib/geocoder/lookups/google.rb#41
  def valid_response?(response); end
end

# source://geocoder//lib/geocoder/lookups/nominatim.rb#5
class Geocoder::Lookup::Nominatim < ::Geocoder::Lookup::Base
  # source://geocoder//lib/geocoder/lookups/nominatim.rb#11
  def map_link_url(coordinates); end

  # source://geocoder//lib/geocoder/lookups/nominatim.rb#7
  def name; end

  private

  # source://geocoder//lib/geocoder/lookups/nominatim.rb#17
  def base_query_url(query); end

  # source://geocoder//lib/geocoder/lookups/nominatim.rb#22
  def configured_host; end

  # source://geocoder//lib/geocoder/lookups/nominatim.rb#40
  def parse_raw_data(raw_data); end

  # source://geocoder//lib/geocoder/lookups/nominatim.rb#48
  def query_url_params(query); end

  # source://geocoder//lib/geocoder/lookups/nominatim.rb#35
  def results(query); end

  # @return [Boolean]
  #
  # source://geocoder//lib/geocoder/lookups/nominatim.rb#26
  def use_ssl?; end
end
...
# source://geocoder//lib/geocoder/results/google.rb#4
class Geocoder::Result::Google < ::Geocoder::Result::Base
  # source://geocoder//lib/geocoder/results/google.rb#10
  def address(format = T.unsafe(nil)); end

  # source://geocoder//lib/geocoder/results/google.rb#98
  ...
  #   :postal_code
  #
  # source://geocoder//lib/geocoder/results/google.rb#112
  def address_components_of_type(type); end

  # source://geocoder//lib/geocoder/results/google.rb#137
  def bounds; end

  # source://geocoder//lib/geocoder/results/google.rb#20
  def city; end

  # source://geocoder//lib/geocoder/results/google.rb#6
  def coordinates; end

  # source://geocoder//lib/geocoder/results/google.rb#56
  def country; end

  # source://geocoder//lib/geocoder/results/google.rb#62
  def country_code; end

  # source://geocoder//lib/geocoder/results/google.rb#94
  def formatted_address; end

  # source://geocoder//lib/geocoder/results/google.rb#116
  def geometry; end

  # source://geocoder//lib/geocoder/results/google.rb#14
  def neighborhood; end

  # source://geocoder//lib/geocoder/results/google.rb#124
  def partial_match; end

  # source://geocoder//lib/geocoder/results/google.rb#128
  def place_id; end

  # source://geocoder//lib/geocoder/results/google.rb#68
  def postal_code; end

  # source://geocoder//lib/geocoder/results/google.rb#120
  def precision; end

  # source://geocoder//lib/geocoder/results/google.rb#74
  def route; end

  # source://geocoder//lib/geocoder/results/google.rb#32
  def state; end

  # source://geocoder//lib/geocoder/results/google.rb#38
  def state_code; end

  # source://geocoder//lib/geocoder/results/google.rb#86
  def street_address; end

  # source://geocoder//lib/geocoder/results/google.rb#80
  def street_number; end

  # source://geocoder//lib/geocoder/results/google.rb#44
  def sub_state; end

  # source://geocoder//lib/geocoder/results/google.rb#50
  def sub_state_code; end

  # source://geocoder//lib/geocoder/results/google.rb#90
  def types; end

  # source://geocoder//lib/geocoder/results/google.rb#132
  def viewport; end

  private

  # source://geocoder//lib/geocoder/results/google.rb#143
  def bounding_box_from(box); end
end
