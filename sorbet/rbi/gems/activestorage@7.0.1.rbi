...
module ActiveStorage::DirectUploadToken
  extend ::ActiveStorage::DirectUploadToken

  def generate_direct_upload_token(attachment_name, service_name, session); end
  def verify_direct_upload_token(token, attachment_name, session); end

  private

  def decode_token(encoded_token); end
  def direct_upload_token(session, attachment_name); end
  def direct_upload_token_hmac(session, identifier); end
  def encode_direct_upload_token(raw_token); end
  def real_direct_upload_token(session); end
  def valid_direct_upload_token?(token, attachment_name, session); end
end

ActiveStorage::DirectUploadToken::DIRECT_UPLOAD_TOKEN_LENGTH = T.let(T.unsafe(nil), Integer)
ActiveStorage::DirectUploadToken::SEPARATOR = T.let(T.unsafe(nil), String)
...
class ActiveStorage::InvalidDirectUploadTokenError < ::ActiveStorage::Error; end
