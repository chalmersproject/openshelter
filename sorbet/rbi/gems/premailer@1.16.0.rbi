...
class Premailer
  ...
  #
  # source://premailer//lib/premailer/premailer.rb#182
  def initialize(html, options = T.unsafe(nil)); end

  # source://premailer//lib/premailer/premailer.rb#355
  ...
  #
  # source://premailer//lib/premailer/premailer.rb#506
  ...
  # Returns a document.
  #
  # source://premailer//lib/premailer/premailer.rb#421
  ...
  # @return [Boolean]
  #
  # source://premailer//lib/premailer/premailer.rb#406
  def is_xhtml?; end
  ...
  # @return [Boolean]
  #
  # source://premailer//lib/premailer/premailer.rb#341
  def local_uri?(uri); end

  # @private
  # @return [Boolean]
  #
  # source://premailer//lib/premailer/premailer.rb#349
  ...
  #
  # source://premailer//lib/premailer/premailer.rb#256
  def warnings; end
  ...
  #
  # source://premailer//lib/premailer/premailer.rb#297
  def load_css_from_html!; end

  # source://premailer//lib/premailer/premailer.rb#263
  def load_css_from_local_file!(path); end

  # @private
  #
  # source://premailer//lib/premailer/premailer.rb#284
  def load_css_from_options!; end

  # source://premailer//lib/premailer/premailer.rb#279
  def load_css_from_string(css_string); end

  class << self
    # from http://www.ruby-forum.com/topic/140101
    #
    # source://premailer//lib/premailer/premailer.rb#499
    def canonicalize(uri); end

    # @private
    # @return [Boolean]
    #
    # source://premailer//lib/premailer/premailer.rb#467
    ...
    # @return [Boolean]
    #
    # source://premailer//lib/premailer/premailer.rb#493
    def local_data?(data); end

    # @private
    #
    # source://premailer//lib/premailer/premailer.rb#472
