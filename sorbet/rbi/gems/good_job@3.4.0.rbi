...
module GoodJob::ActiveJobExtensions::Concurrency
  ...
  # @return [Object] concurrency key
  #
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#97
...
module GoodJob::ActiveJobExtensions::Concurrency::ClassMethods
  # source://good_job//lib/good_job/active_job_extensions/concurrency.rb#90
...
class GoodJob::Adapter
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#140
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#103
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#110
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#118
  ...
  # @return [Symbol, nil]
  #
  # source://good_job//lib/good_job/adapter.rb#97
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/adapter.rb#83
  def shutdown(timeout: T.unsafe(nil)); end
...
class GoodJob::Notifier
  ...
  #
  # source://good_job//lib/good_job/notifier.rb#70
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/notifier.rb#129
  ...
  #
  # source://good_job//lib/good_job/notifier.rb#82
  def listening?; end
  ...
  #
  # source://good_job//lib/good_job/notifier.rb#67
  def recipients; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/notifier.rb#120
  def restart(timeout: T.unsafe(nil)); end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/notifier.rb#105
  def shutdown(timeout: T.unsafe(nil)); end
  ...
  # source://good_job//lib/good_job/notifier.rb#151
  def create_executor; end

  # Returns the value of attribute executor.
  #
  # source://good_job//lib/good_job/notifier.rb#149
  def executor; end

  # source://good_job//lib/good_job/notifier.rb#155
  def listen(delay: T.unsafe(nil)); end

  # source://good_job//lib/good_job/notifier.rb#207
  def wait_for_notify; end

  # source://good_job//lib/good_job/notifier.rb#195
  ...
  class << self
    ...
    #
    # source://good_job//lib/good_job/notifier.rb#48
    def instances; end
    ...
    #
    # source://good_job//lib/good_job/notifier.rb#58
