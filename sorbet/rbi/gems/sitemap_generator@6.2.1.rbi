...
class SitemapGenerator::AwsSdkAdapter
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/adapters/aws_sdk_adapter.rb#28
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/adapters/aws_sdk_adapter.rb#39
  ...
  # source://sitemap_generator//lib/sitemap_generator/adapters/aws_sdk_adapter.rb#51
...
class SitemapGenerator::LinkSet
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#150
  def add(link, options = T.unsafe(nil)); end
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#167
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#343
  def finalize!; end
  ...
  # +default_host+.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#198
  ...
  # @return [Boolean]
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#352
  def include_index?; end
  ...
  # @return [Boolean]
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#362
  def include_root?; end

  # Return a count of the total number of links in all sitemaps
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#312
  def link_count; end
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#282
  def ping_search_engines(*args); end

  # Lazy-initialize a sitemap instance and return it.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#323
  def sitemap; end

  # Lazy-initialize a sitemap index instance and return it.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#328
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#338
  def sitemap_index_url; end

  # Return the host to use in links to the sitemap files.  This defaults to your
  # +default_host+.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#318
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#369
  def verbose; end
  ...
  # @return [Boolean]
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#377
  def yield_sitemap?; end
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#439
  ...
  # sitemap.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#460
  def finalize_sitemap!; end

  # Finalize a sitemap index and output a summary line.  Do nothing if it has already
  # been finalized.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#472
  def finalize_sitemap_index!; end

  # Return the interpreter linked to this instance.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#479
  def interpreter; end
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#403
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#495
  def output(string); end

  # Reset this instance.  Keep the same options, but return to the same state
  # as before any sitemaps were created.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#486
  def reset!; end
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#388
  def set_options(opts = T.unsafe(nil)); end
end

# source://sitemap_generator//lib/sitemap_generator/link_set.rb#500
module SitemapGenerator::LinkSet::LocationHelpers
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#654
  def compress; end
  ...
  # groups, pass in a `:compress` option e.g. <tt>group(:compress => false) { add('/link') }</tt>
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#646
  ...
  # one sitemap file.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#613
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#506
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#558
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#632
  def namer; end
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#623
  def namer=(value); end

  # Return a Pathname with the full path to the public directory
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#528
  def public_path; end
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#518
  def public_path=(value); end

  # Return the hash of search engines.
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#573
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#546
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#535
  ...
  #
  # source://sitemap_generator//lib/sitemap_generator/link_set.rb#662
