...
# This is an autogenerated file for dynamic methods in `DashboardAdmin::AdminController`.
# Please instead update this file by running `bin/tapioca dsl DashboardAdmin::AdminController`.

class DashboardAdmin::AdminController
