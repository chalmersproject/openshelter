...
# This is an autogenerated file for dynamic methods in `GoodJobAdmin::AdminController`.
# Please instead update this file by running `bin/tapioca dsl GoodJobAdmin::AdminController`.

class GoodJobAdmin::AdminController
