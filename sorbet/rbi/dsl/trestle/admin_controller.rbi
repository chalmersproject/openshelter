...
# This is an autogenerated file for dynamic methods in `Trestle::AdminController`.
# Please instead update this file by running `bin/tapioca dsl Trestle::AdminController`.
