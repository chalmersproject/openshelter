...
# This is an autogenerated file for dynamic methods in `Trestle::DashboardController`.
# Please instead update this file by running `bin/tapioca dsl Trestle::DashboardController`.
