...
class GoodJob::ActiveJobJob
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::GoodJob::ActiveJobJob).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::GoodJob::ActiveJobJob).void)).returns(::GoodJob::ActiveJobJob) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::GoodJob::ActiveJobJob, T::Enumerable[T.any(::GoodJob::ActiveJobJob, T::Enumerable[::GoodJob::ActiveJobJob])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::GoodJob::ActiveJobJob, Integer, String, T::Enumerable[T.any(::GoodJob::ActiveJobJob, Integer, String, T::Enumerable[::GoodJob::ActiveJobJob])])).returns(T::Array[::GoodJob::ActiveJobJob]) }
    ...
    sig { params(other_array: T.any(::GoodJob::ActiveJobJob, T::Enumerable[T.any(::GoodJob::ActiveJobJob, T::Enumerable[::GoodJob::ActiveJobJob])])).returns(T::Array[::GoodJob::ActiveJobJob]) }
