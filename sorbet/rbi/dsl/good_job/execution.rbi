...
class GoodJob::Execution
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::GoodJob::Execution).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::GoodJob::Execution).void)).returns(::GoodJob::Execution) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig { params(records: T.any(::GoodJob::Execution, T::Enumerable[T.any(::GoodJob::Execution, T::Enumerable[::GoodJob::Execution])])).returns(PrivateCollectionProxy) }
    def <<(*records); end
    ...
    sig { params(records: T.any(::GoodJob::Execution, Integer, String, T::Enumerable[T.any(::GoodJob::Execution, Integer, String, T::Enumerable[::GoodJob::Execution])])).returns(T::Array[::GoodJob::Execution]) }
    ...
    sig { params(other_array: T.any(::GoodJob::Execution, T::Enumerable[T.any(::GoodJob::Execution, T::Enumerable[::GoodJob::Execution])])).returns(T::Array[::GoodJob::Execution]) }
