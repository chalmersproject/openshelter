...
# This is an autogenerated file for dynamic methods in `UsersAdmin::AdminController`.
# Please instead update this file by running `bin/tapioca dsl UsersAdmin::AdminController`.

class UsersAdmin::AdminController
