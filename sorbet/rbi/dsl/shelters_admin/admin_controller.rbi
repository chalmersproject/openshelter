...
# This is an autogenerated file for dynamic methods in `SheltersAdmin::AdminController`.
# Please instead update this file by running `bin/tapioca dsl SheltersAdmin::AdminController`.

class SheltersAdmin::AdminController
